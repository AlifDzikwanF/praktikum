    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sample_form').on('submit', function(event){
                ...
                if($('#action').val() == "Add"){
                    ...
                    $.ajax({
                        url:"http://localhost/apipraktikum/api/employees/create.php",
                        method:"POST",
                    ...
                    $.ajax({
                        url:"http://localhost/apipraktikum/api/employees/update.php",
                        method:"PUT",
                        data: JSON.stringify(formData),
                        success:function(data){
                            $('#action_button').attr('disabled', false);
        ...
        function showAll() {
            $.ajax({
                    ...
                    url: "http://localhost/apipraktikum/api/employees/read.php",
        ...
        function showOne(id) {
            ...
            $.ajax({
                    type: "GET",
                    contentType: "application/json",
                    url: "http://localhost/apipraktikum/api/employees/read.php?id="+id,
                    success: function(response) { 
                        $('#id').val(response.id);
        ...
        function deleteOne(id) {
            ...
            $.ajax({
                url:"http://localhost/apipraktikum/api/employees/delete.php",
                method:"DELETE",
